...
@Entity
@Table(name = "mechworkshop")
public class MechWorkshop {
	...
	public MechWorkshop(String fullName, String email, String mobNumber, String courseName, String coursePrice,
	...
	public String toString() {
		return "MechWorkshop [workshopid=" + workshopid + ", fullName=" + fullName + ", email=" + email + ", mobNumber="
