...
@Entity
public class DigitalManyCourseWorkshop {
	...
	public DigitalManyCourseWorkshop() {
		super();
		// TODO Auto-generated constructor stub
	}

	public DigitalManyCourseWorkshop(String fullName, String email, String mobNumber, String[] courseName,
	...
	public String toString() {
		return "ItManyCourseWorkshop [workshopid=" + workshopid + ", fullName=" + fullName + ", email=" + email
				+ ", mobNumber=" + mobNumber + ", courseName=" + Arrays.toString(courseName) + ", coursePrice="
				+ coursePrice + ", RzrpOrderId=" + RzrpOrderId + ", RzrpPaymentId=" + RzrpPaymentId + ", RzrpSign="
				+ RzrpSign + ", PaymentStatus=" + PaymentStatus + "]";
	}
